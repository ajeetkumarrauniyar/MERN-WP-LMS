// Create a context for managing color mode and theme
import { createContext, useMemo, useState } from "react";
import { createTheme } from "@mui/material/styles";

// Color tokens based on the selected mode (dark or light)
...
// MUI theme settings based on the selected color mode
...
export const useMode = () => {
  ...
  // Color mode context with a toggle function
  ...
  // Memoized theme based on the current color mode
